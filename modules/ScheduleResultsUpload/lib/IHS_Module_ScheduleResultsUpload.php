...
class IHS_Module_ScheduleResultsUpload extends I2CE_Module {
    
    public static function getHooks() {
        return array(
'validate_form_schedule_results_upload'=>'validate_form_schedule_results_upload'
                );
    }
    
    public function validate_form_schedule_results_upload($form)
    {
