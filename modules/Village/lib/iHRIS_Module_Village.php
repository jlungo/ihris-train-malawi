...
class iHRIS_Module_Village extends I2CE_Module {
    ...
    public function pre_upgrade( $old_vers, $new_vers, $new_storage ) {
        if ( I2CE_Validate::checkVersion( $old_vers, '<', '3.2.3' ) ) {
            ...
            I2CE_FormStorage::storeMigrateData( array("ward" => array( "county" ) ),
                    $migrate_path );
        }
...
/*
  ...
  */          
            ...
            */
            unset( $class_config->iHRIS_Village->fields->type );
            unset( $class_config->iHRIS_Village->fields->district );
            unset( $class_config->iHRIS_Village->fields->region );
            unset( $class_config->iHRIS_Village->fields->country );
        }
